...
// Запуск: OLLCHAT_TEST_SERVER=http://ollama.example:11434 go test ./internal/agent/ -v
//
...
// Запуск:
//
//	OLLCHAT_TEST_SERVER=http://ollama.example:11434 OLLCHAT_TEST_MODEL=qwen3.5:122b \
