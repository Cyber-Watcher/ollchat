...
func TestItalicsEnabledНастройкаСильнееТерминала(t *testing.T) {
...
func TestApplyItalicsПравитСтилиЛенты(t *testing.T) {
...
func TestDisableItalicsЧиститСтильGlamour(t *testing.T) {
...
func TestDisableItalicsИдётВглубь(t *testing.T) {
	yes := true
...
func TestКонфигПроверяетЗначениеItalic(t *testing.T) {
	dir := t.TempDir()
