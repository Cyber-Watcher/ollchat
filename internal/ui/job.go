...
func (m *Model) handleJobDone(msg jobDoneMsg) {
	...
	if m.kbColl != nil {
		m.kbColl = nil // сведения о коллекции устарели, перечитаем при надобности
	}
}
...
// shortenMiddle сокращает длинное имя книги, оставляя начало и конец.
