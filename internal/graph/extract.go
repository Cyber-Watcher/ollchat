...
// нечем, а значит, и хранить её незачем. Синонимы сверяются с текстом куска.
//
...
//
// Проверка действует для ОБОИХ форматов графа с 03.09.2026: сборка (build.go)
// передаёт текст куска всегда, и рабочий граф формата 1 с тех пор собран
// с ней. Пустой chunkText отключает проверку — это только для тестов,
