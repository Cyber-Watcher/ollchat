...
func TestDoctorЛовитВытеснениеВОперативнуюПамять(t *testing.T) {
...
func TestDoctorНеВидитВытесненияКогдаВсёНаКарте(t *testing.T) {
...
func TestDoctorПроверкуМожноВыключить(t *testing.T) {
...
func TestDoctorRestartЖдётПодъёма(t *testing.T) {
	var restarted bool
	d := &Doctor{
...
func TestHeartbeatМёртвыйПроцесс(t *testing.T) {
	root := t.TempDir()
