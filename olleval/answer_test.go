...
func TestExtractCodeБерётСамыйДлинныйБлокЯзыка(t *testing.T) {
	answer := "Было так:\n\n```go\nfunc a() {}\n```\n\nСтало:\n\n```go\nfunc a() int {\n\treturn 42\n}\n```\n"
...
func TestExtractCodeБезПометкиЯзыка(t *testing.T) {
	answer := "```\nprint(1)\n```"
...
func TestExtractCodeПустоКогдаКодаНет(t *testing.T) {
